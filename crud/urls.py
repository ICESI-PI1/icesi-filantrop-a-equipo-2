...
from .views import login, save_student, request_info_update, upload_scholarship_data, upload_non_academic_report, estudiantes, upload_CREA_report, upload_academic_report, api, assign_donor
...
urlpatterns = [
    ...
    path('assignDonor/', assign_donor.assign_donor),
]
