...
class testsE2E(LiveServerTestCase):
    ...
    def test_login_except(self):
        ...
        blockEcp = selenium.find_element(By.XPATH, '/html/body/section/div/div/div/div/div/div[2]/div/form/p')
        self.assertTrue(blockEcp.is_displayed())  # Verifica que el bloque sea visible
        time.sleep(2)
    ...
    def test_upload_scholarship(self):
        ...
        buttonRegEst.send_keys(Keys.RETURN)
        selenium.find_element(By.ID, 'file').send_keys("C:\\Users\\Jacobo Ossa\\OneDrive - Universidad Icesi (@icesi.edu.co)\\Escritorio\\TestApoyoFinanciero.xlsx")
    ...
    def test_upload_BU_Activities(self):
        ...
        buttonRegEst.send_keys(Keys.RETURN)
        selenium.find_element(By.ID, 'file').send_keys("C:\\Users\\Jacobo Ossa\\OneDrive - Universidad Icesi (@icesi.edu.co)\\Escritorio\\TestBienestarUniversitario.xlsx")
        uploadbutton = selenium.find_element(By.ID,'inputGroupFileAddon04')
        uploadbutton.send_keys(Keys.RETURN)
        # Wait for some time for the processing to complete (adjust the sleep duration as needed)
        time.sleep(2)
    ...
    def test_upload_Academic_Report(self):
        ...
        buttonRegEst.send_keys(Keys.RETURN)
        selenium.find_element(By.ID, 'file').send_keys("C:\\Users\\Jacobo Ossa\\OneDrive - Universidad Icesi (@icesi.edu.co)\\Escritorio\\A00381321.pdf")
        uploadbutton = selenium.find_element(By.ID,'inputGroupFileAddon04')
        uploadbutton.send_keys(Keys.RETURN)
        # Wait for some time for the processing to complete (adjust the sleep duration as needed)
        time.sleep(2)
    ...
    def test_upload_BU_Activities(self):
        ...
        buttonRegEst.send_keys(Keys.RETURN)
        selenium.find_element(By.ID, 'file').send_keys("C:\\Users\\Jacobo Ossa\\OneDrive - Universidad Icesi (@icesi.edu.co)\\Escritorio\\TestCREA.xlsx")
        uploadbutton = selenium.find_element(By.ID,'inputGroupFileAddon04')
        uploadbutton.send_keys(Keys.RETURN)
        # Wait for some time for the processing to complete (adjust the sleep duration as needed)
        time.sleep(2)
